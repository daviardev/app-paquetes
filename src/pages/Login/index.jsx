                ...
                <div className='login__forms'>
                    {!toggle && (
                        ...
                        <div className='login__box'>
                            ...
                            <input type='text' placeholder='Usuario' className='login__input' required />
                        </div>
    
                        <div className='login__box'>
                            <FaLock className='login__icon' />
                            <input type='password' placeholder='Contraseña' className='login__input' required />
                        </div>
                    ...
                    {toggle && (
                        ...
                        <div className='login__box'>
                            <FaUserAlt className='login__icon' />
                            <input type='text' placeholder='Nombres y apellidos' className='login__input' required />
                        </div>
    
                        <div className='login__box'>
                            <AiFillIdcard className='login__icon' />
                            <input type='text' placeholder='No. identificación' className='login__input' required />
                        </div>

                        <div className='login__box'>
                            <MdEmail className='login__icon' />
                            <input type='email' placeholder='Correo' className='login__input' required />
                        </div>
